 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <div class="sidebar">
         ...
         <nav class="mt-2">
             ...
             @if (in_array(auth()->guard('admin')->user()->kategori,
                     ['Admin', 'Tim Administratif', 'Tim Lapangan', 'Pemilik Menara', 'Provider']))
                 <li class="nav-header">MANAJEMEN MENARA</li>
             @endif
             @if (in_array(auth()->guard('admin')->user()->kategori,
                     ['Admin', 'Tim Administratif', 'Tim Lapangan', 'Pemilik Menara']))
                 <li class="nav-item">
             ...
             @endif
             {{-- @if (in_array(
        auth()->guard('admin')->user()->kategori,
        ['Pemilik Menara'],
    ))
          <li class="nav-item">
            <a href="#" class="nav-link">
          ...
          @endif --}}
             @if (in_array(auth()->guard('admin')->user()->kategori,
                     ['Tim Administratif', 'Tim Lapangan', 'Pemilik Menara']))
                 <li class="nav-item">
