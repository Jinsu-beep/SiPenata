                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('menara') is-invalid @enderror" id="perusahaan"
                                    name="perusahaan" data-placeholder="Provinsi" style="width: 100%;">
        ...
        function laporan() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#laporan').append(
                        '<div class="card-header"> <a class="btn btn-primary" type="button" href="/laporan/downloadLaporan/' +
                        id +
                    ...
                    response.forEach(function(element, index) {
                        ...
                        perusahaan.forEach(element1 => {
                            if (element1.perusahaan.id == element.pemilik_menara
                                .id_perusahaan) {
                                namaPerusahaan = element1.perusahaan.nama
                            }
                        });
                        $('#body').append('<tr> <td class="text-center">' + no +
                            '</td> <td class="text-center">' + namaPerusahaan +
                            '</td> <td class="text-center">' + element['no_menara'] +
                            '</td> <td class="text-center">' + element.kecamatan.nama +
                            '</td> <td class="text-center">' + element['tinggi_menara'] +
                            '</td> <td class="text-center">' + element['lat'] + ', ' + element[
                                'long'] + '</td> </tr>');
                    });
                }
            });
