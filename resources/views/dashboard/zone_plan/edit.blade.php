        ...
        <div class="row">
            <div class="col-md-4 col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="/zoneplan/update/{{ $dataZonePlan->id }}" id="form-desa" method="post"
                            enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-group">
                                <label for="nama">Nama Zone Plan</label>
                                <input type="text" class="form-control" name="nama" id="nama"
                                    placeholder="Nama Zone Plan" value="{{ $dataZonePlan->nama }}">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control select2" id="provinsi" name="provinsi"
                                    ...
                                    @foreach ($dataProvinsi as $dp)
                                        <option value="{{ $dp->id }}"
                                            @if ($dataZonePlan->id_provinsi == $dp->id) selected @endif>{{ $dp->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group mb-3">
            ...
            success: function(response) {
                ...
                response.forEach(element => {
                    if (element.id == data_zonePlan.id_kabupaten) {
                        $('#kabupaten').append('<option value="' + element['id'] + '"' + ' selected>' +
                            element['nama'] + '</option>');
                    } else {
                        $('#kabupaten').append('<option value="' + element['id'] + '"' + '>' + element[
                            'nama'] + '</option>');
                    }
                });
            }
            ...
            success: function(response) {
                ...
                response.forEach(element => {
                    if (element.id == data_zonePlan.id_kecamatan) {
                        $('#kecamatan').append('<option value="' + element['id'] + '"' + ' selected>' +
                            element['nama'] + '</option>');
                    } else {
                        $('#kecamatan').append('<option value="' + element['id'] + '"' + '>' + element[
                            'nama'] + '</option>');
                    }
                });
            }
            ...
            success: function(response) {
                ...
                response.forEach(element => {
                    if (element.id == data_zonePlan.id_desa) {
                        $('#desa').append('<option value="' + element['id'] + '"' + ' selected>' +
                            element['nama'] + '</option>');
                    } else {
                        $('#desa').append('<option value="' + element['id'] + '"' + '>' + element[
                            'nama'] + '</option>');
                    }
                });
            }
