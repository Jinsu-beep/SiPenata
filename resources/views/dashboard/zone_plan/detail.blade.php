                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" id="nama"
                                placeholder="Nama Zone Plan" value="{{ $dataZonePlan->nama }}" readonly>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" id="kabupaten" name="kabupaten"
                                data-placeholder="Kabupaten" style="width: 100%;" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="kecamatan" name="kecamatan"
                                data-placeholder="Kecamatan" style="width: 100%;" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="lat" id="lat"
                                value="{{ $dataZonePlan->lat }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Longitude</label>
                            <input type="text" class="form-control" name="lng" id="lng"
                                value="{{ $dataZonePlan->long }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Radius</label>
                            <input type="text" class="form-control" name="rad" id="rad"
                                value="{{ $dataZonePlan->radius }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Batas Menara</label>
                            <input type="number" class="form-control" name="batasMenara" id="batasMenara"
                                value="{{ $dataZonePlan->batas_menara }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="status">Status</label>
                            <select class="form-control select2" name="status" id="status" data-placeholder="Status"
                                style="width: 100%;" disabled>
                                <option value="available" @if ($dataZonePlan->status == 'available') selected @endif>Available
                                </option>
                                <option value="used" @if ($dataZonePlan->status == 'used') selected @endif>Used</option>
                                <option value="terlarang" @if ($dataZonePlan->status == 'terlarang') selected @endif>Terlarang
                                </option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                        id="detail_provinsi" value="" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                        id="detail_kabupaten" value="" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                        id="detail_kecamatan" value="" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10 align-self-center">
                                    <input type="text" class="form-control" placeholder="Tanggal Pembuatan"
                                        id="tanggalPembuatan" value="" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                        id="tinggiMenara" value="" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                        id="tinggiAntena" value="" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
...
@push('js')
    ...
    <script>
        ...
        menara.forEach(element => {
            // console.log(element)
            marker = L.marker([element.lat, element.long]).bindPopup(
                '<div class="row"> <div class="col align-self-start"> No Menara : ' + element.no_menara +
                '<br>Jenis Menara : ' + element.jenis_menara +
                '<hr></div> <div class="w-100"></div> <div class="col align-self-center"> <button onclick="detailMenara(' +
                element.id + ')" class="btn btn-primary float-center">Detail</button> </div> </div>');
        ...
        function detailMenara(id) {
            menara.forEach(element => {
                if (element.id == id) {
                    ...
                    $('#detail_provinsi').val(element.provinsi.nama);
                    $('#detail_kabupaten').val(element.kabupaten.nama);
                    $('#detail_kecamatan').val(element.kecamatan.nama);
                    $('#detail_desa').val(element.desa.nama);
                    $('#tanggalPembuatan').val(element.tanggal_pembuatan);
                    $('#dlat').val(element.lat);
                    $('#dlng').val(element.long);
