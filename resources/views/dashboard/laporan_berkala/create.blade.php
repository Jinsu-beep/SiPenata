                ...
                <form action="/laporanBerkala/insert/{{ $dataUser->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 @error('perusahaan') is-invalid @enderror" id="perusahaan"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 @error('menara') is-invalid @enderror" id="menara"
                                name="menara" data-placeholder="Provinsi" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control @error('laporan') is-invalid @enderror" name="laporan" id="laporan"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.forEach(element => {
                            $('#menara').append('<option value="' + element['id'] + '"' + '>' +
                                element['no_menara'] + '</option>');
                        });
                    }
                });
            }
