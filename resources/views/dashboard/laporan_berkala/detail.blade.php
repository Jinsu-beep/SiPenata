                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="row mb-2">  
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" placeholder="Tanggal Pengajuan" value="{{ $laporan->tanggal_laporan }}" disabled>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <label for="provinsi" class="col-sm-2 col-form-label">Perusahaan</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" placeholder="Tanggal Pengajuan" value="{{ $laporan->Perusahaan->nama }}" disabled>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <label for="kabupaten" class="col-sm-2 col-form-label">Menara</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" placeholder="Tanggal Pengajuan" value="{{ $laporan->Menara->no_menara }}" disabled>
                            </div>
                        </div>
                        <div class="row mb-2">
