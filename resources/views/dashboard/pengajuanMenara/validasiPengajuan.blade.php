...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            @if (in_array(auth()->guard('admin')->user()->kategori,
                    ['Tim Administratif']))
                @if ($status->Status->status == 'Pemeriksaan Oleh Tim Administrasi')
                    <form action="/pengajuan/validateTimAdministratif/{{ $detailPengajuan->id }}" method="POST"
                        enctype="multipart/form-data">
                    @elseif ($status->Status->status == 'Pengajuan Disetujui')
                        <form action="/pengajuan/akhirPengajuan/{{ $detailPengajuan->id }}" method="POST"
                            enctype="multipart/form-data">
                @endif
            @elseif (in_array(auth()->guard('admin')->user()->kategori,
                    ['Tim Lapangan']))
                <form action="/pengajuan/validateTimLapangan/{{ $detailPengajuan->id }}" method="POST"
                    enctype="multipart/form-data">
            @endif
            @csrf
                        ...
                        <div class="bs-stepper-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Nama" placeholder="Name"
                                            value="{{ $detailPengajuan->PemilikMenara->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Kewarganegaraan"
                                            ...
                                            value="{{ $detailPengajuan->PemilikMenara->Kewarganegaraan }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="Email" placeholder="Email"
                                            value="{{ $detailPengajuan->PemilikMenara->email }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="no_telp" placeholder="no_telp"
                                            value="{{ $detailPengajuan->PemilikMenara->no_telp }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="NoKTP" placeholder="Name"
                                            value="{{ $detailPengajuan->PemilikMenara->no_ktp }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="NPWP" placeholder="Name"
                                            value="{{ $detailPengajuan->PemilikMenara->NPWP }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="provinsi" placeholder="Provinsi"
                                            value="{{ $detailPengajuan->PemilikMenara->Provinsi->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="kabupaten"
                                            ...
                                            value="{{ $detailPengajuan->PemilikMenara->Kabupaten->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="kecamatan"
                                            ...
                                            value="{{ $detailPengajuan->PemilikMenara->Kecamatan->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="desa" placeholder="Desa"
                                            value="{{ $detailPengajuan->PemilikMenara->Desa->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="nama_perusahaan"
                                            placeholder="Name"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="email_perusahaan"
                                            placeholder="Name"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->email }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="noTelp_perusahaan"
                                            placeholder="Email"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->no_telp }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="provinsi" placeholder="Provinsi"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->Provinsi->nama }}"
                                            disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="kabupaten"
                                            placeholder="Kabupaten"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->Kabupaten->nama }}"
                                            disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="kecamatan"
                                            placeholder="Kecamatan"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->Kecamatan->nama }}"
                                            disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="desa" placeholder="Desa"
                                            value="{{ $detailPengajuan->PemilikMenara->perusahaan->Desa->nama }}"
                                            disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div id="menara-part" class="content" role="tabpanel" aria-labelledby="menara-part-trigger">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Longitude" name="provinsi"
                                        id="provinsi" value="{{ $detailPengajuan->Provinsi->nama }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Kabupaten</label>
                                    <input type="text" class="form-control" placeholder="Longitude" name="kabupaten"
                                        id="kabupaten" value="{{ $detailPengajuan->Kabupaten->nama }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Kecamatan</label>
                                    <input type="text" class="form-control" placeholder="Longitude" name="kecamatan"
                                        id="kecamatan" value="{{ $detailPengajuan->Kecamatan->nama }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Desa</label>
                                    <input type="text" class="form-control" placeholder="Longitude" name="desa"
                                        id="desa" value="{{ $detailPengajuan->Desa->nama }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Jenis Menara</label>
                                    <input type="text" class="form-control" placeholder="Longitude" name="provinsi"
                                        id="provinsi" value="{{ $detailPengajuan->jenis_menara }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Tinggi Menara (Meter)</label>
                                    <input type="text" class="form-control" placeholder="Tinggi Menara"
                                        name="tinggiMenara" value="{{ $detailPengajuan->tinggi_menara }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Tinggi Antena (Meter)</label>
                                    <input type="text" class="form-control" placeholder="Tinggi Antena"
                                        name="tinggiAntena" value="{{ $detailPengajuan->tinggi_antena }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Luas Area (Meter Persegi)</label>
                                    <input type="number" class="form-control" placeholder="Luas Area" name="luasArea"
                                        value="{{ $detailPengajuan->luas_area }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Akses Jalan</label>
                                    <input type="text" class="form-control" placeholder="Akses Jalan"
                                        name="aksesJalan" value="{{ $detailPengajuan->akses_jalan }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Status Lahan</label>
                                    <input type="text" class="form-control" placeholder="Longitude" name="provinsi"
                                        id="provinsi" value="{{ $detailPengajuan->status_lahan }}" disabled>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status1" id="statusFile1"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile1->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile1->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile1->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status2" id="statusFile2"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile2->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile2->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile2->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status3" id="statusFile3"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile3->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile3->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile3->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status4" id="statusFile4"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile4->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile4->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile4->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status5" id="statusFile5"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile5->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile5->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile5->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status6" id="statusFile6"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile6->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile6->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile6->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status7" id="statusFile7"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile7->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile7->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile7->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover mt-1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width='250px'>
                                                    <select class="form-control select2" name="status8" id="statusFile8"
                                                        data-placeholder="Pilih Status" style="width: 100%;"
                                                        @if ($detailFile8->status == 'disetujui') disabled @endif>
                                                        <option selected disabled>Status ...</option>
                                                        <option value="perbaiki"
                                                            @if ($detailFile8->status == 'perbaiki') selected @endif>Perbaiki
                                                        </option>
                                                        <option value="disetujui"
                                                            @if ($detailFile8->status == 'disetujui') selected @endif>Disetujui
                                                        </option>
                                                    </select>
                                                </td>
                                            </tr>
                    ...
                    @if ($status->Status->status == 'Pengajuan Disetujui')
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="file_rekomendasiPembangunan"
                                    name="file_rekomendasiPembangunan">
                        ...
                        @if ($status->Status->status == 'Pemeriksaan Oleh Tim Administrasi')
                            <div class="row justify-content-between">
                                <button type="submit" name="action" class="btn btn-warning"
                                    value="perbaiki">Perbaiki</button>
                                <button type="submit" name="action" class="btn btn-primary"
                                    value="diterima">Diterima</button>
                            </div>
                        @elseif ($status->Status->status == 'Pengajuan Disetujui')
                            <div class="row justify-content-end">
