                ...
                <div class="card-body p-0">
                    <div class="bs-stepper">
                        ...
                        <div class="bs-stepper-content">
                            ...
                            <form action="/pengajuan/insert/{{ $dataUser->id }}" method="POST"
                                ...
                                <div id="menara-part" class="content" role="tabpanel"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Latitude" name="lat" id="lat" readonly>
                                                @error('lat')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Longitude" name="lng" id="lng" readonly>
                                                @error('lng')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control select2 @error('kabupaten') is-invalid @enderror"
                                            name="kabupaten" id="menara_kabupaten" data-placeholder=" Kabupaten "
                                            style="width: 100%;">
                                        </select>
                                        @error('kabupaten')
                                            <div class="invalid-feedback text-start">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control select2 @error('kecamatan') is-invalid @enderror"
                                            name="kecamatan" id="menara_kecamatan" data-placeholder=" Kecamatan "
                                            style="width: 100%;">
                                        </select>
                                        @error('kecamatan')
                                            <div class="invalid-feedback text-start">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control select2 @error('desa') is-invalid @enderror"
                                            name="desa" id="menara_desa" data-placeholder=" Desa "
                                            style="width: 100%;">
                                        </select>
                                        @error('desa')
                                            <div class="invalid-feedback text-start">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('luasArea') is-invalid @enderror"
