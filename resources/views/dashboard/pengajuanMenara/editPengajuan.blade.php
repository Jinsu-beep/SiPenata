...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/pengajuan/updatePengajuan/{{ $detailPengajuan->id }}" method="POST"
                            ...
                            <div class="bs-stepper-content">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" id="Email"
                                                placeholder="Email" value="{{ $dataUser->email }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="no_telp"
                                                placeholder="no_telp" value="{{ $dataUser->no_telp }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="provinsi"
                                                placeholder="Provinsi" value="{{ $dataUser->Provinsi->nama }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="kecamatan"
                                                placeholder="Kecamatan" value="{{ $dataUser->Kecamatan->nama }}"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" id="noTelp_perusahaan"
                                                placeholder="Email" value="{{ $dataUser->perusahaan->no_telp }}"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="kabupaten"
                                                ...
                                                value="{{ $dataUser->perusahaan->Kabupaten->nama }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="kecamatan_perusahaan"
                                            class="col-sm-2 col-form-label">Kecamatan</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="kecamatan"
                                                placeholder="Kecamatan"
                                                value="{{ $dataUser->perusahaan->Kecamatan->nama }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div id="menara-part" class="content" role="tabpanel"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control select2" name="provinsi" id="menara_provinsi"
                                            data-placeholder=" Provinsi " style="width: 100%;">
                                            <option value="{{ $detailPengajuan->id_provinsi }}">
                                                {{ $detailPengajuan->Provinsi->nama }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Kabupaten</label>
                                        <select class="form-control select2" name="kabupaten" id="menara_kabupaten"
                                            data-placeholder=" Kabupaten " style="width: 100%;">
                                            <option value="{{ $detailPengajuan->id_kabupaten }}">
                                                {{ $detailPengajuan->Kabupaten->nama }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Kecamatan</label>
                                        <select class="form-control select2" name="kecamatan" id="menara_kecamatan"
                                            data-placeholder=" Kecamatan " style="width: 100%;">
                                            <option value="{{ $detailPengajuan->id_kecamatan }}">
                                                {{ $detailPengajuan->Kecamatan->nama }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Desa</label>
                                        <select class="form-control select2" name="desa" id="menara_desa"
                                            data-placeholder=" Desa " style="width: 100%;">
                                            <option value="{{ $detailPengajuan->id_desa }}">
                                                {{ $detailPengajuan->Desa->nama }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Jenis Menara</label>
                                        <select class="form-control select2" name="jenisMenara" id="jenisMenara"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tinggi Menara"
                                            name="tinggiMenara" id="tinggiMenara"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tinggi Antena"
                                            name="tinggiAntena" value="{{ $detailPengajuan->tinggi_antena }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Luas Area (Meter Persegi)</label>
                                        <input type="number" class="form-control" placeholder="Luas Area"
                                            name="luasArea" value="{{ $detailPengajuan->luas_area }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Akses Jalan</label>
                                        <input type="text" class="form-control" placeholder="Akses Jalan"
                                            name="aksesJalan" value="{{ $detailPengajuan->akses_jalan }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="NPWP">Status Lahan</label>
                                        <select class="form-control select2" name="statusLahan" id="statusLahan"
                                            data-placeholder="Status Lahan" style="width: 100%;">
                                        ...
                                        @if ($detailFile1->status == 'perbaiki')
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="file_KTPPemohon">Choose
                                                        file</label>
                                                </div>
                                            </div>
                                        ...
                                        @if ($detailFile4->status == 'perbaiki')
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="file_suratKuasa">Choose
                                                        file</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input "
                                                        id="file_rancangBangun" name="file_rancangBangun">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        @if ($detailFile6->status == 'perbaiki')
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input "
                                                        id="file_denahBangunan" name="file_denahBangunan">
                                        ...
                                        @if ($detailFile8->status == 'perbaiki')
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="file_suratTanah">Choose
                                                        file</label>
                                                </div>
                                            </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status" id="status"
                                ...
                                <option value="perbaiki" @if ($detailPengajuan->PengajuanStatusTerakhir->Status->status == 'Perbaikan Administrasi') selected @endif>perbaiki
                                </option>
                                <option value="diterima" @if ($detailPengajuan->PengajuanStatusTerakhir->Status->status == 'Disetujui Tim Administratif') selected @endif>diterima
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
