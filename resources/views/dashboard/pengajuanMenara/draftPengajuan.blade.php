                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="tanggalPengajuan"
                                    placeholder="Tanggal Pengajuan" value="" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="tanggalPengajuan"
                                    placeholder="Status Pengajuan" value="{{ $detailPengajuan->status }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="dataMenara-tab" data-toggle="pill" href="#dataMenara" role="tab"
                                    aria-controls="dataMenara" aria-selected="false">Data Menara</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            <div class="tab-pane fade" id="dataMenara" role="tabpanel" aria-labelledby="dataMenara-tab">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @if ($detailPengajuan->Provinsi == null)
                                        <input type="text" class="form-control" placeholder="Provinsi"
                                            name="provinsi" id="provinsi" value="" readonly>
                                    @else
                                        <input type="text" class="form-control" placeholder="Provinsi"
                                            name="provinsi" id="provinsi"
                                            value="{{ $detailPengajuan->Provinsi->nama }}" readonly>
                                    @endif
                                </div>
                                <div class="form-group mb-3">
                                    <label for="NPWP">Kabupaten</label>
                                    @if ($detailPengajuan->Kabupaten == null)
                                        <input type="text" class="form-control" placeholder="Kabupaten"
                                            name="kabupaten" id="kabupaten" value="" readonly>
                                    @else
                                        <input type="text" class="form-control" placeholder="Kabupaten"
                                            name="kabupaten" id="kabupaten"
                                            value="{{ $detailPengajuan->Kabupaten->nama }}" readonly>
                                    @endif
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @if ($detailPengajuan->Kecamatan == null)
                                        <input type="text" class="form-control" placeholder="Kecamatan"
                                            name="kecamatan" id="kecamatan" value="" readonly>
                                    @else
                                        <input type="text" class="form-control" placeholder="Kecamatan"
                                            name="kecamatan" id="kecamatan"
                                            value="{{ $detailPengajuan->Kecamatan->nama }}" readonly>
                                    @endif
