                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center" width='150px'>
                                                <button type="button" onclick="showFileRekomendasi()" class="btn btn-primary">
                                                    Show File
                                                </button>
                                            </td>
                                            <td class="text-center" width='150px'>
                                                <a type="button" href="/pengajuan/download/{{ $detailPengajuan->id }}" class="btn btn-primary">
                                                    Download
                                                </a>
                                            </td>
                                        </tr>
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div>
                                            ...
                                            <div class="timeline-item">
                                                <span class="time"><i class="fas fa-clock"></i>{{ $ps->tanggal_status }}</span>
