                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($dataPengajuan as $dp)
                                        @if (in_array(auth()->guard('admin')->user()->kategori,
                                                ['Tim Administratif']))
                                            @if ($dp->PengajuanStatusTerakhir != null)
                                                @if ($dp->PengajuanStatusTerakhir->Status->status == 'Pemeriksaan Oleh Tim Administrasi')
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="/pengajuan/validasiPengajuan/{{ $dp->id }}"
                                        ...
                                        @elseif (in_array(auth()->guard('admin')->user()->kategori,
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($dp->status == 'draft')
                                                        <a href="/pengajuan/draftPengajuan/{{ $dp->id }}"
                                                            class="btn btn-info btn-icon-split">
                                                            <span class="icon">
                                                                <i class="fas fa-eye"></i>
                                                            </span>
                                                    ...
                                                    @elseif ($dp->status == 'diajukan')
                                                        @if ($dp->PengajuanStatusTerakhir->Status->status == 'Perbaikan Administrasi')
                                                            <a href="/pengajuan/editPengajuan/{{ $dp->id }}"
                                                                class="btn btn-info btn-icon-split">
                                                                <span class="icon">
                                                                    <i class="fas fa-eye"></i>
                                                                </span>
                                                        ...
                                                        @else
                                                            <a href="/pengajuan/detailPengajuan/{{ $dp->id }}"
                                                                class="btn btn-info btn-icon-split">
                                                                <span class="icon">
                                                                    <i class="fas fa-eye"></i>
                                                                </span>
