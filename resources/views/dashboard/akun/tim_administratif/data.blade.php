                                    ...
                                    @foreach ($dataTimAdministratif as $dta)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button value="{{ $dta->id }}"
                                                    id="edit_TimAdministratif{{ $dta->id }}"
                                                    class="btn btn-warning btn-icon-split">
                                                    <span class="icon">
                                                        <i class="fas fa-edit"></i>
                                                    </span>
                                                </button>
                                                <button onclick="statusdelete({{ $dta->id }})" id="delete_akun"
                ...
                <form action="" id="create_form" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="id_opd" id="id_opd" data-placeholder="Pilih OPD"
                                style="width: 100%;">
            ...
            <div class="modal-content">
                <form action="" id="edit_form" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="password">Password</label>
                            <select class="form-control select2" name="id_opd" id="edit_id_opd"
                ...
                if ($('edit_TimAdministratif').val() != "") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#edit_form").attr("action", "/timadministratif/update/" +
                                response.id);
