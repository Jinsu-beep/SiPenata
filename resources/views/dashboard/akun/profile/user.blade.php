                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#perusahaan" data-toggle="tab">Perusahaan</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="active tab-pane" id="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="Kewarganegaraan"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="no_telp" placeholder="no_telp"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="NoKTP" placeholder="Name"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="NPWP" placeholder="Name"
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="provinsi" id="provinsi"
                                            ...
                                            @foreach ($provinsi as $p)
                                                <option value="{{ $p->id }}"
                                                    @if ($dataUser->id_provinsi == $p->id) selected @endif>{{ $p->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="kabupaten" id="kabupaten"
                                            ...
                                            @foreach ($kabupaten as $kb)
                                                <option value="{{ $kb->id }}"
                                                    @if ($dataUser->id_kabupaten == $kb->id) selected @endif>{{ $kb->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="kecamatan" id="kecamatan"
                                            ...
                                            @foreach ($kecamatan as $kc)
                                                <option value="{{ $kc->id }}"
                                                    @if ($dataUser->id_kecamatan == $kc->id) selected @endif>{{ $kc->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="desa" id="desa"
                                            ...
                                            @foreach ($desa as $d)
                                                <option value="{{ $d->id }}"
                                                    @if ($dataUser->id_desa == $d->id) selected @endif>{{ $d->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="Alamat" placeholder="Name"
                                            value="{{ $dataUser->alamat }}" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="Username" class="col-sm-2 col-form-label">Username</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Username" placeholder="Skills"
                            ...
                            <div class="tab-pane" id="perusahaan">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="id_opd" id="id_opd"
                                            ...
                                            @foreach ($provinsi as $p)
                                                <option value="{{ $p->id }}"
                                                    @if ($dataUser->perusahaan->id_provinsi == $p->id) selected @endif>{{ $p->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="id_opd" id="id_opd"
                                            ...
                                            @foreach ($kabupaten as $kb)
                                                <option value="{{ $kb->id }}"
                                                    @if ($dataUser->perusahaan->id_kabupaten == $kb->id) selected @endif>{{ $kb->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="id_opd" id="id_opd"
                                            ...
                                            @foreach ($kecamatan as $kc)
                                                <option value="{{ $kc->id }}"
                                                    @if ($dataUser->perusahaan->id_kecamatan == $kc->id) selected @endif>{{ $kc->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="id_opd" id="id_opd"
                                            ...
                                            @foreach ($desa as $d)
                                                <option value="{{ $d->id }}"
                                                    @if ($dataUser->perusahaan->id_desa == $d->id) selected @endif>{{ $d->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="alamat_perusahaan"
                                            placeholder="Name" value="{{ $dataUser->perusahaan->alamat }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="kewarganegaraan"
                                data-placeholder="Kewarganegaraan" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="noKTP" id="edit_noKTP"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="provinsi" id="edit_provinsi"
                                data-placeholder="Pilih OPD" style="width: 100%;">
                                <option selected disabled>Pilih Provinsi ...</option>
                                @foreach ($provinsi as $p)
                                    <option value="{{ $p->id }}"
                                        @if ($dataUser->id_provinsi == $p->id) selected @endif>{{ $p->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="kabupaten">Kabupaten</label>
                            <select class="form-control select2" name="kabupaten" id="edit_kabupaten"
                                data-placeholder="Pilih OPD" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="kecamatan" id="edit_kecamatan"
                                data-placeholder="Pilih OPD" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="desa" id="edit_desa"
                                data-placeholder="Pilih OPD" style="width: 100%;">
