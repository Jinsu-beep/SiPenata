                                    ...
                                    @foreach ($dataTimLapangan as $dtl)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button value="{{ $dtl->id }}" id="edit_TimLapangan{{ $dtl->id }}"
                                                    class="btn btn-warning btn-icon-split">
                                                    <span class="icon">
                                                        <i class="fas fa-edit"></i>
                                                    </span>
                                                </button>
                                                <button onclick="statusdelete({{ $dtl->id }})" id="delete_akun"
                ...
                if ($('edit_TimLapangan').val() != "") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $("#edit_form").attr("action", "/timlapangan/update/" + response
                            .id);
