                        ...
                        <div class="tab-content">
                            <div class="p-2">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#perusahaan"
                            ...
                            <div class="active tab-pane" id="user">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="No Dasar Hukum"
                                        value="{{ $userPemilikMenara->no_ktp }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">NPWP</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->NPWP }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Kewarganegaraan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->Kewarganegaraan }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Email</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->email }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">No Telepon</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->no_telp }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Provinsi</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->Provinsi->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Kabupaten</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->Kabupaten->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Kecamatan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->Kecamatan->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Desa</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->Desa->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Alamat</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $userPemilikMenara->alamat }}" readonly>
                                </div>
                            </div>
                            <div class="tab-pane" id="perusahaan">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Email Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->email }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">No Telepon Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->no_telp }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Provinsi Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->Provinsi->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Kabupaten Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->Kabupaten->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Kecamatan Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->Kecamatan->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Desa Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->Desa->nama }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_dasarHukum">Alamat Perusahaan</label>
                                    <input type="text" class="form-control" placeholder="Nama Dasar Hukum"
                                        value="{{ $perusahaanPemilikMenara->alamat }}" readonly>
                                </div>
                                <div class="form-group">
                                                ...
                                                <td width='250px'>
                                                    @if ($detailPerusahaan1->status == 'disetujui')
                                                        <select class="form-control select2" name="status1"
                                                            id="statusFile1" data-placeholder="Pilih Status"
                                                ...
                                                <td width='250px'>
                                                    @if ($detailPerusahaan2->status == 'disetujui')
                                                        <select class="form-control select2" name="status2"
                                                            id="statusFile2" data-placeholder="Pilih Status"
                                                            style="width: 100%;" disabled>
                                                            <option disabled>tunggu persetujuan</option>
                                                            <option value="perbaiki">perbaiki</option>
                                                            <option value="disetujui" selected>disetujui</option>
