            ...
            <form action="/perusahaan/update/{{ $dataUser->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nama Perusahaan" name="nama" value="{{ $dataRegistrasi->nama }}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="email_perusahaan">Email Perusahaan</label>
                        <input type="text" class="form-control" placeholder="Email Perusahaan" name="email" value="{{ $dataRegistrasi->email }}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="no_telp_perusahaan">No Telepon Perusahaan</label>
                        <input type="text" class="form-control" placeholder="No Telepon Perusahaan" name="no_telp" value="{{ $dataRegistrasi->no_telp }}">
                    </div>
                    <div class="form-group mb-3">
