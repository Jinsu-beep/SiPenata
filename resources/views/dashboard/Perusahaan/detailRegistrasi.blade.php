                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Nama Perusahaan" name="nama"
                            value="{{ $dataRegistrasi->nama }}" readonly>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Email Perusahaan" name="email"
                            value="{{ $dataRegistrasi->email }}" readonly>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="No Telepon Perusahaan" name="no_telp"
                            value="{{ $dataRegistrasi->no_telp }}" readonly>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control select2" id="kabupaten" name="kabupaten" data-placeholder="Kabupaten"
                            style="width: 100%;" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="kecamatan" name="kecamatan" data-placeholder="Kecamatan"
                            style="width: 100%;" disabled>
