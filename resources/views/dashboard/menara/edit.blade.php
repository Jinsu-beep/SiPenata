                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-5 align-self-center text-center">
                            <iframe src="{{ $detailMenara->foto }}" frameborder="0" width="450" height="600"></iframe>
                        </div>
                        <div class="col-sm-7">
                            <div class="row mb-2">  
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10 align-self-center">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan" value="{{ $detailMenara->tanggal_pembuatan }}" disabled>
                                </div>
                            </div>
                            <div class="row mb-2">
