                            ...
                            <div class="col-sm-7">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->no_menara }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->Provinsi->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->Kabupaten->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->Kecamatan->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->Desa->nama }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <label for="tanggalPembuatan" class="col-sm-2 col-form-label">Tanggal
                                        Pembuatan</label>
                                    <div class="col-sm-10 align-self-center">
                                        <input type="text" class="form-control" placeholder="Tanggal Pembuatan"
                                            value="{{ $detailMenara->tanggal_pembuatan }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->lat }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->long }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->jenis_menara }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->tinggi_menara }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->tinggi_antena }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->luas_area }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                            value="{{ $detailMenara->akses_jalan }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <label for="aksesJalan" class="col-sm-2 col-form-label">File Surat Ijin
                                        Pembangunan</label>
                                    <div class="col-sm-10 align-self-center">
                                        <button type="button" onclick="showFilePembangunan()"
                                ...
                                <div class="row mb-2">
                                    <label for="aksesJalan" class="col-sm-2 col-form-label">File Surat Ijin
                                        Operasional</label>
                                    <div class="col-sm-10 align-self-center">
                                        <button type="button" onclick="showFileOperasional()"
                                            class="btn btn-primary text-center">
                                            Show File
                                        </button>
                                    </div>
                                    ...
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            @if (in_array(auth()->guard('admin')->user()->kategori,
                                                ...
                                                <th width="100px">
                                                    <button type="button"
                                                        onclick="tambahPengguna({{ $detailMenara->id }})"
                                                        class="btn btn-info">
                                                        <span class="icon">
                                            ...
                                            <tr>
                                                ...
                                                @if (in_array(auth()->guard('admin')->user()->kategori,
                                                    ...
                                                    <td class="text-center">
                                                        <button onclick="deletePengguna({{ $dp->id }})"
                                                            id="delete_akun" class="btn btn-danger btn-icon-split">
                                                            <span class="icon">
                ...
                <form action="" id="tambahPengguna" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="pengguna" id="edit_desa"
                ...
                <form action="" id="edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input"
                                    data-target="#reservationdate" name="tanggalPembuatan" />
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input @error('fotoMenara') is-invalid @enderror"
                                    id="fotoMenara" name="fotoMenara">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file"
                                    class="custom-file-input @error('file_pembangunan') is-invalid @enderror"
                                    id="file_pembangunan" name="file_pembangunan">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file"
                                    class="custom-file-input @error('file_operasional') is-invalid @enderror"
                                    id="file_operasional" name="file_operasional">
...
@push('js')
    ...
    <script>
        ...
        L.circle([marker.lat, marker.long], {
