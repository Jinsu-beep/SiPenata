        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                @if (in_array(auth()->guard('admin')->user()->kategori,
                        ['Super Admin', 'Admin', 'Tim Administratif', 'Tim Lapangan']))
                    <div class="col-lg-4 col-6">
            ...
            @if (in_array(auth()->guard('admin')->user()->kategori,
                ...
                @elseif ($perusahaan->status == 'tunggu persetujuan')
                    <div class="callout callout-info">
                        ...
                        <p>Menunggu validasi dari Admin. Untuk Melihat detail klik <a
                                href="/perusahaan/detailRegistrasi/{{ $dataUser->id_perusahaan }}">di sini</a>.</p>
                    </div>
                @elseif ($perusahaan->status == 'perbaiki')
                    <div class="callout callout-warning">
                        <h5>Status Pendaftaran Perusahaan : Diperbaiki</h5>
                        <p>Terdapat data yang harus diperbaiki. Untuk memperbaiki data klik <a
                                href="/perusahaan/edit/{{ $dataUser->id_perusahaan }}">di sini</a>.</p>
                    </div>
