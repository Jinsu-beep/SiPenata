                        ...
                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" class="checkboxMenara"
                                                id="namaPerusahaan{{ $lp->id }}" value="{{ $lp->id }}">
                                            <label for="namaPerusahaan{{ $lp->id }}">
                                                {{ $lp->perusahaan->nama }}
                                            </label>
                                        </div>
                                    </div>
                            ...
                            @foreach ($kecamatan as $k)
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" class="checkboxKecamatan"
                                                id="namaKecamatan{{ $k->id }}" value="{{ $k->id }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Tanggal Pengajuan"
                                        id="penggunaMenara" value="" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        dataPerusahaan.forEach(element => {
                            if (element1.pemilik_menara.id_perusahaan == element.perusahaan
                                ...
                                marker = L.marker([element1.lat, element1.long], {
                                    ...
                                    '<div class="row"> <div class="col align-self-start"> No Menara : ' +
                                    element1.no_menara + '<br>Jenis Menara : ' + element1
                                    .jenis_menara +
                                    '<hr></div> <div class="w-100"></div> <div class="col align-self-center"> <button onclick="detailMenara(' +
                                    element1.id +
                                    ')" class="btn btn-primary float-center">Detail</button> </div> </div>'
                                );
                                mymap.addLayer(marker);
                                markers.push(marker)
        ...
        function detailMenara(id) {
            ...
            menara.forEach(element => {
                ...
                if (element.id == id) {
                    ...
                    $('#perusahaan').val(element.no_menara);
